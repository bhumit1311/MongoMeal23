...
import { Plus, Heart, Eye, Search, SlidersHorizontal, Clock, Star, ChefHat, ChevronDown, Loader2 } from 'lucide-react';
...
const filterChips = [
  'All', 'Starters', 'Main Course', 'Rice Dishes', 'Breads', 'Desserts', 'Beverages'
];
