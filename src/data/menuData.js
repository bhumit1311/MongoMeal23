...
export const tastingMenu = [
  { course: 1, name: 'Farsan Platter', title: 'Dhokla & Khandvi', description: 'A delightful assortment of steamed gram flour cakes and delicate rolls.', wine: 'Masala Chaas' },
  { course: 2, name: 'Warm Appetizer', title: 'Methi Gota', description: 'Crispy fenugreek fritters with tangy tamarind chutney.', wine: 'Sweet Lime Soda' },
  { course: 3, name: 'Main Course', title: 'Undhiyu & Puri', description: 'Traditional mixed vegetable curry served with freshly fried puffed bread.', wine: 'Keri No Ras' },
  { course: 4, name: 'Dal Course', title: 'Dal Dhokli', description: 'Spiced wheat dumplings in a sweet and tangy lentil stew.', wine: '' },
  { course: 5, name: 'Grand Dessert', title: 'Shrikhand & Mohanthal', description: 'Saffron-flavored strained yogurt and rich gram flour fudge.', wine: 'Piyush' },
];
...
export const dashboardOrders = [
  {
    ...
    items: [
      { name: 'Undhiyu', qty: 1, price: 600 },
      { name: 'Khaman Dhokla', qty: 1, price: 250 },
      { name: 'Shrikhand', qty: 2, price: 350 },
      { name: 'Keri No Ras', qty: 2, price: 300 },
    ]
  },
  {
    id: 'ORD-2024-002', date: '2024-11-28', status: 'Completed',
    items: [
      { name: 'Khandvi', qty: 2, price: 300 },
      { name: 'Dal Dhokli', qty: 1, price: 500 },
      { name: 'Basundi', qty: 1, price: 400 },
    ]
  },
  {
    id: 'ORD-2025-003', date: '2025-01-10', status: 'Completed',
    items: [
      { name: 'Sev Tameta Nu Shak', qty: 2, price: 450 },
      { name: 'Vaghareli Chaas', qty: 3, price: 150 },
    ]
  },
];
